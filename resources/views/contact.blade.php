                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>madrukbook@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                                <h5 class="section-title ff-secondary fw-normal text-start text-primary">General</h5>
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>madruk@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <!-- <iframe class="position-relative rounded w-100 h-100"
                            src="img/pexels-pixabay-260922.jpg"
                            frameborder="0" style="min-height: 350px; border:0;" allowfullscreen="" aria-hidden="false"
                            tabindex="0"></iframe> -->
                            <img src="img/pexels-pixabay-260922.jpg" alt="" style="width: 648px;height: 370px;">
                    </div>
                    <div class="col-md-6">
